download the iam dataset from->https://www.kaggle.com/datasets/nibinv23/iam-handwriting-word-database

our file must have
1)text recognition ipynb file
2)a folder name data having  
  -a sub folder-words(containing all the training dataset)
  -a  tgz file of words
  -a word.txt file
...
get all these from iam dataset
